import { VideoData, Video } from "./data.types";
...
export const data: VideoData = {
  videos: [
    ...
    },
    {
      ...
      statistics: "160,653 views • 24 Mar 2021",
      description: "If you're new to cycling and you're enjoying riding your bike, it won't be long before you want to start setting yourself some goals! If you've never done it before, riding 50km in one go can be a real challenge, and might take you a good few hours! However, armed with these handy tips, you'll be well equipped to go out and ride further than you've ever ridden before!",
      channelName: "Global Cycling Network",
      channelLogo: "https://yt3.ggpht.com/ytc/AAUvwnhTfv0TDTol99arvnHmHi5J41sB682iFGUc0flXRQ=s88-c-k-c0x00ffffff-no-rj"
    },
  ],
